...
<table id="dtBasicExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
  ...
  <?php foreach ($datos as $d) : ?>
          ...
          <tr>  
            ...
            <td><a href="?controller=user&accion=actuser&id=<?= $d['id'] ?>"><i class="fas fa-user-edit"></i> Editar </a><a href="?controller=user&accion=deluser&id=<?= $d['id'] ?>"><i class="fas fa-trash-alt"></i> Eliminar</a></td>
          </tr>
    <?php endforeach; ?>
</table>
</div>